...
胡帅飞，博士，现从事数学与计算数学相关教学与科研工作。

主要研究方向为**偏微分方程数值解、有限元方法、谱方法以及复杂区域上的高效数值方法**。近年来主要围绕复杂管道区域上的偏微分方程数值求解开展研究，重点关注高阶有限差分方法、谱方法及有限元方法等。
...
近年来主要从事偏微分方程数值方法及其在复杂几何区域中的应用研究。
